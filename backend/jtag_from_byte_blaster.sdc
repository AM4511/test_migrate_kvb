...
proc set_jtag_timing_constraints { } {
    ...
    # if { $use_fitter_specific_constraint && [string equal quartus_fit $::Info(nameofexecutable)] } {
    ...
    #    # reports show whether the JTAG logic in the FPGA core will operates in this setup.
...
#     create_clock -name {jtag_tck_usb_blaster} -period $jtag_33Mhz_t_period [get_ports {altera_reserved_tck}]
#     set_clock_groups -asynchronous -group {jtag_tck_usb_blaster}
...
proc set_tck_timing_spec { } {
    ...
    create_clock -name {jtag_tck_usb_blaster} --add -period $tck_t_period [get_ports {altera_reserved_tck}]
    set_clock_groups -asynchronous -group {jtag_tck_usb_blaster}
}
...
proc set_tms_timing_spec { } {
    ...
    # ---customize here---
    # Node JTAG_TMS: From J14/Pin-5 to A51-G/Pin-E3
    ...
    set_input_delay -add_delay -clock_fall -clock jtag_tck_usb_blaster -max $tms_in_max [get_ports {altera_reserved_tms}]
    set_input_delay -add_delay -clock_fall -clock jtag_tck_usb_blaster -min $tms_in_min [get_ports {altera_reserved_tms}]
}
...
proc set_tdi_timing_spec_when_driven_by_blaster { } {
    ...
    set_input_delay -add_delay -clock_fall -clock jtag_tck_usb_blaster -max $tdi_in_max [get_ports {altera_reserved_tdi}]
    set_input_delay -add_delay -clock_fall -clock jtag_tck_usb_blaster -min $tdi_in_min [get_ports {altera_reserved_tdi}]
}
...
proc set_tdo_timing_spec_when_drive_blaster { } {
    ...
    set_output_delay -add_delay -clock_fall -clock jtag_tck_usb_blaster -max $tdo_out_max [get_ports {altera_reserved_tdo}]
    set_output_delay -add_delay -clock_fall -clock jtag_tck_usb_blaster -min $tdo_out_min [get_ports {altera_reserved_tdo}]
}
...
proc set_tdo_timing_spec_when_drive_device { } {
    ...
    set_output_delay -add_delay -clock jtag_tck_usb_blaster -max $tdo_out_max [get_ports {altera_reserved_tdo}]
    set_output_delay -add_delay -clock jtag_tck_usb_blaster -min $tdo_out_min [get_ports {altera_reserved_tdo}]
}
