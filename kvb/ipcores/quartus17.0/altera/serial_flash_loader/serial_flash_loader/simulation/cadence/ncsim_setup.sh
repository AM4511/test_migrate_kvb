...
TOP_LEVEL_NAME="serial_flash_loader"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_serial_flash_loader.v" -work serial_flash_loader_0 -cdslib ./cds_libs/serial_flash_loader_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/serial_flash_loader.v"                                                                                               
fi
